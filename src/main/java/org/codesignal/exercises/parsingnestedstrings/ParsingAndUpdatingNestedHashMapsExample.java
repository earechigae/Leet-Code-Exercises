...
This task involves transforming a given string into a nested HashMap and updating a specific key-value pair within that map.
The input string will take the form "Key1=Value1,Key2=Value2,...".
...
public class ParsingAndUpdatingNestedHashMapsExample {
